 ...
 * Healthcare is set to 2× CPI to reflect persistently higher medical cost inflation.
 */
export const DEFAULT_CATEGORIES = [
  ...
  { key: 'healthcare', label: 'Healthcare', amount: 11000, inflationMultiplier: 2.0, perPersonScale: 1.0 },
